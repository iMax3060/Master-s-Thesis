...
\newcommand{\fullfildegree}{Master of Science}                   % the degree this thesis is part of its fullfilment
...
\newcommand{\releasedate}{\specificdate{2020}{9}{14}}            % the release date of the thesis
\newcommand{\city}{Kaiserslautern}                               % the city of submission
\newcommand{\advisor}{\begin{de}Dr.-Ing. Caetano Sauer\end{de}}    % the advisor of the thesis	
...
\usepackage{enumitem}      % gives more control over itemize, enumerate and description environments
\setlist{nosep}            % removes the separation (additional to \baselineskip) between items in itemize, enumerate and description environments
...
\includeonly{./tex/titlepage,./tex/declaration,./tex/abstract,\ignore{}./tex/page_evictioners,./tex/looking_glas,\ignore{}./tex/tu_logo,./tex/command_definitions_early,./tex/command_definitions_late}
